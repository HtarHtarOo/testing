		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a href="" class="addtocartBtn text-decoration-none"  data-id="{{$item->id}}" data-name="{{$item->name}}" data-price="{{$item->price}}"  data-discount="{{$item->discount}}" data-photo="{{$item->photo}}">Add to Cart</a>
